object frmLocContato: TfrmLocContato
  Left = 225
  Top = 117
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Localizar Contato'
  ClientHeight = 401
  ClientWidth = 351
  Color = clBtnFace
  ...
  object rdNMCONT: TRadioButton
    ...
    TabOrder = 0
    TabStop = True
    OnClick = rdNMCONTClick
  end
  object rbNMEMPR: TRadioButton
    Left = 136
    Top = 14
    Width = 113
    Height = 17
